...
bool NaomiSelectFile(void* handle)
{
	...
	if(cfgLoadInt(L"Naomi", L"LoadDefaultRom",0)!=0)
	{
		cfgLoadStr(L"Naomi", L"DefaultRom", SelectedFile, L"default.lst");
		//wprintf(L"Loading default rom: %s\n", SelectedFile);
	}
	else
	{
