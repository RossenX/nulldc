...
enum ndc_events
{
	...
	NDE_PVR_RECORDEDFRAMECOUNT,
	NDE_PVR_PLAYBACKFRAMECOUNT,

	NDE_PVR_RECORD,
	NDE_PVR_PLAYBACK,

	NDE_AICA_TOGGLE_AUDIO_SYNC,
	//Misc
...
typedef void EXPORT_CALL ConfigReloadFP();
