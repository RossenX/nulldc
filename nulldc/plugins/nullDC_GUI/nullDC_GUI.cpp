...
void LoadSettings()
{
	...
	settings.AlwaysOnTop=emu.ConfigLoadInt(L"nullDC_GUI",L"AlwaysOnTop",1) ? true : false;

#if defined(BUILD_NAOMI) || defined(BUILD_ATOMISWAVE)
	settings.AutoLoad = emu.ConfigLoadInt(L"Naomi", L"LoadDefaultRom", 0) ? true : false;
#endif
}
